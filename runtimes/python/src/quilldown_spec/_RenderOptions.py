...
class RenderOptions:
    ...
    def load(data: Any, context: LoadContext | None = None) -> "RenderOptions":
        ...
        if not isinstance(data, dict):
            raise ValueError(f"Invalid data for RenderOptions: {data}")
    ...
    def save(self, context: SaveContext | None = None) -> dict[str, Any]:
        """Save the RenderOptions instance to a dictionary.
        Args:
    ...
    def to_yaml(self, context: SaveContext | None = None) -> str:
        """Convert the RenderOptions instance to a YAML string.
        Args:
            context (Optional[SaveContext]): Optional context with pre/post processing callbacks.
        Returns:
    ...
    def to_json(self, context: SaveContext | None = None, indent: int = 2) -> str:
        """Convert the RenderOptions instance to a JSON string.
        Args:
            context (Optional[SaveContext]): Optional context with pre/post processing callbacks.
